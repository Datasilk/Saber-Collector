S.subjects = {
    ...
    add: {
        ...
        save: function () {
            ...
            S.ajax.post('/CollectorSubjects/AddSubjects', { subjects: subjects, hierarchy: hierarchy, loadUI: true },
                function (data) {
    ...
    select: {
        show: function (id, pid, breadcrumb, speed, noload) {
            ...
            if (noload != true) {
                S.ajax.post('/CollectorSubjects/LoadSubjectsUI', { parentId: id, getHierarchy: false, isFirst: false }, function (data) {
    ...
    move: {
        ...
        submit: function () {
            ...
            S.ajax.post('/CollectorSubjects/MoveSubject', { id: id, hierarchy: hier, element: '.subjects-list > .inner' },
                function (data) {
