var article = {
    ...
    init: function () {
        ...
        article.hub.on('update-url', article.analyze.updateUrl);
    ...
    analyze: {
        ...
        updateUrl: function (url) {
            //receive command from SignalR
            var uri = updateQueryString(location.href, 'url', encodeURIComponent(url));
            history.pushState(null, '', new URL(uri));
        },
