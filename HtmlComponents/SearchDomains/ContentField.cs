...
namespace Saber.Vendors.Collector.HtmlComponents.UI.ContentFields.SearchDomains
{
    [ContentField("search-domains")]
    public class ContentField : IVendorContentField
    {
        ...
        {
            var viewfield = new View("/Vendors/Collector/HtmlComponents/SearchDomains/contentfield.html");
