...
namespace Saber.Vendors.Collector.HtmlComponents.UI.ContentFields.FeedDropdown
{
    [ContentField("feed-dropdown")]
    public class ContentField : IVendorContentField
    {
        ...
        {
            var viewfield = new View("/Vendors/Collector/HtmlComponents/FeedDropdown/contentfield.html");
