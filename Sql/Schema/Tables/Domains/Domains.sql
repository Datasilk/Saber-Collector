BEGIN TRY
    ...
    (
        ...
        [type] INT NOT NULL DEFAULT -1, -- 0 = unused, 1 = website, 2 = ecommerce, 3 = wiki, 4 = blog, 5 = science journal, 6 = SASS, 7 = social network, 8 = advertiser, 9 = search engine, 10 = portfolio
