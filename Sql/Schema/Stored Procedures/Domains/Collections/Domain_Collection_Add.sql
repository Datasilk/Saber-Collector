...
AS
	...
	INSERT INTO DomainCollections (colId, colgroupId, [name], [search], subjectId, filtertype, [type], [sort], datecreated)
	VALUES (@id, @colgroupId, @name, @search, @subjectId, @filtertype, @type, @sort, GETUTCDATE())
	SELECT @id